	...
	public Context execute(Object datos) {
		...
		try {
			...
			resultado.setEvento(sesiones != null ? Evento.RES_MOSTRAR_SESIONES_DISPONIBLES_CLIENTE_OK
					: Evento.RES_MOSTRAR_SESIONES_DISPONIBLES_CLIENTE_KO);
			resultado.setMessage(sesiones != null ? "Sesiones disponibles cargadas." : "No se pudieron cargar las sesiones.");
		} catch (Exception e) {
			resultado.setEvento(Evento.RES_MOSTRAR_SESIONES_DISPONIBLES_CLIENTE_KO);
